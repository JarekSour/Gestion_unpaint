...
;( function( window ) {
  ...
  FForm.prototype._addControls = function() {
    ...
    this.ctrlContinue = createElement( 'button', { cName : 'fs-continue', type: "button", inner : 'Continue', appendTo : this.ctrls } );
    ...
    if( this.options.ctrlNavDots ) {
      ...
      for( var i = 0; i < this.fieldsCount; ++i ) {
        dots += i === this.current ? '<button type="button" class="fs-dot-current"></button>' : '<button disabled></button>';
      }
  ...
  FForm.prototype._showError = function( err ) {
    ...
    switch( err ) {
      case 'NOVAL' :
        message = 'Favor rellene bien los campos antes de continuar';
        break;
      case 'INVALIDEMAIL' :
        message = 'Favor de ingresar una dirección de correo valida';
        break;
      // ...
    };
